    ...
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="border-t border-border bg-panel">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-3 px-4 py-9 text-center sm:px-6">
          <Logo size={28} />
          <p className="text-sm text-muted">{company.slogan[lang]}</p>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-5 right-4 z-50 flex h-13 w-13 items-center justify-center rounded-full bg-[#1f9e54] shadow-lg shadow-black/30"
      >
